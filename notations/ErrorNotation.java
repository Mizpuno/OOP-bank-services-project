...
public class ErrorNotation {
    public ErrorNotation (int index) {
        switch (index) {
            ...
            case 400 -> System.out.print("""
                            
                            \033[0;90m(400) \033[0;91mUsername Repeat!\u001B[0m
                            It seem is username is already used by other user. Please try again.
                            """);
